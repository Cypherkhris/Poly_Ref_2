...
import org.anddev.andengine.engine.Engine.State;
...
public class TextureManager {
	...
	public void onDrawFrame(Engine engine, final GL10 pGL) {
		final State threadLocker = engine.mThreadLocker;
	
		threadLocker.waitUntilCanDraw();
	
		updateTextures(pGL);
		engine.mFontManager.updateFonts(pGL);
		if(GLHelper.EXTENSIONS_VERTEXBUFFEROBJECTS) {
			engine.mBufferObjectManager.updateBufferObjects((GL11) pGL);
		}
	
		engine.onDrawScene(pGL);
