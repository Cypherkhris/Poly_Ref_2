...
public class Texture {
	...
	final ArrayList<TextureSourceWithLocation> mTextureSources = new ArrayList<TextureSourceWithLocation>();

	private final ITextureStateListener mTextureStateListener;

	boolean mUpdateOnHardwareNeeded = false;
	...
	public void loadToHardware(final GL10 pGL) {
		...
		this.mTextureOptions.applyTextureOptions(this, pGL);
	...
	private void allocateAndBindTextureOnHardware(final GL10 pGL) {
		...
		this.mTextureOptions.sendPlaceholderBitmapToHardware(this.mWidth, this.mHeight);
	}
