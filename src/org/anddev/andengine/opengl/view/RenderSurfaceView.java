...
public class RenderSurfaceView extends GLSurfaceView {
	...
	public static class Renderer implements GLSurfaceView.Renderer {
		...
		public void onSurfaceCreated(final GL10 pGL, final EGLConfig pConfig) {
			...
			GLHelper.enableExtensions(pGL, this.mEngine.mSoundManager.getEngineOptions(this.mEngine).getRenderOptions());
		}

		@Override
		public void onDrawFrame(final GL10 pGL) {
			this.mEngine.mTextureManager.onDrawFrame(this.mEngine, pGL);
		}
