...
public class Engine implements SensorEventListener, OnTouchListener, ITouchEventCallback, TimeConstants {
	...
	public final State mThreadLocker = new State();
	...
	public ITouchController mTouchController = new SingleTouchControler();

	public SoundManager mSoundManager;
	public MusicManager mMusicManager;	
	public final TextureManager mTextureManager = new TextureManager();
	public final BufferObjectManager mBufferObjectManager = new BufferObjectManager();
	public final FontManager mFontManager = new FontManager();
	...
	/**
	 * @deprecated Use {@link org.anddev.andengine.sensor.orientation.OrientationData#onTouch(org.anddev.andengine.engine.Engine,View,MotionEvent)} instead
	 */
	@Override
	public boolean onTouch(final View pView, final MotionEvent pSurfaceMotionEvent) {
		return mOrientationData.onTouch(this, pView, pSurfaceMotionEvent);
	}
	...
	public void onDrawScene(final GL10 pGL) {
