...
public class Scene extends Entity {
	...
	/**
	 * @deprecated Use {@link org.anddev.andengine.input.touch.TouchEvent#onChildSceneTouchEvent(org.anddev.andengine.entity.scene.Scene)} instead
	 */
	protected boolean onChildSceneTouchEvent(final TouchEvent pSceneTouchEvent) {
		return pSceneTouchEvent.onChildSceneTouchEvent(this);
	}
