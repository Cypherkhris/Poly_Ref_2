...
public abstract class BaseGameActivity extends BaseActivity implements IGameInterface {
	...
	protected void onCreate(final Bundle pSavedInstanceState) {
		...
		this.applyEngineOptions(this.mEngine.mSoundManager.getEngineOptions(this.mEngine));
	...
	protected void onResume() {
		...
		this.mEngine.start();
		this.acquireWakeLock(this.mEngine.mSoundManager.getEngineOptions(this.mEngine).getWakeLockOptions());
	}
	...
	public SoundManager getSoundManager() {
		return this.mEngine.mMusicManager.getSoundManager(this.mEngine);
	}
	...
	protected LayoutParams createSurfaceViewLayoutParams() {
		...
		return this.mEngine.mSoundManager.getEngineOptions(this.mEngine).getResolutionPolicy().createLayoutParams(displayMetrics);
	}
